package com.lt.recyclerview_album.util;
...
public class GlideUtil {
    ...
    private static final int errorSoWhite = android.R.color.white;
    ...
    public static <T> void loadImageSizekipMemoryCache(Context context, T url, ImageView imageView) {
        RequestOptions options = new RequestOptions()
                .placeholder(placeholderSoWhite)//占位图
                .error(errorSoWhite)//错误图
