...
public class OkHttpUtil {
    ...
    public static void postJsonRequest(String url, Map<String, String> params,
                                       DataCallBack callBack) {
    ...
    private void postJsonAsync(String url, Map<String, String> params,
                               final DataCallBack callBack) {
        //将Map转换成Json，需要引入Gson包
        String mapToJson = new Gson().toJson(params);
        RequestBody requestBody = RequestBody.create(
                MediaType.parse("application/json; charset=utf-8"), mapToJson);//创建请求体
